...
st.write('¿Qué se le puede escribir a un hombre así, que evidentemente ha perdido el rumbo'
         'un hombre del que se puede sentir pena, pero al que no se puede ayudar? ' 
         '  '
